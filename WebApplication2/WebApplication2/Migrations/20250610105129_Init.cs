        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BestTimeInSectonds = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 9, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Mushroom Kingdom", "200CC" },
                    { 2, new DateTime(2026, 9, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "Florida, USA", "300CC" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 100.52m, "Rainbow Road" },
                    { 2, 212m, "Coconut Mall" },
                    { 3, 555.12m, "Some Other Track" }
                });

            migrationBuilder.InsertData(
                table: "Track_Race",
                columns: new[] { "TrackRaceId", "BestTimeInSectonds", "Laps", "RaceId", "TrackId" },
                values: new object[,]
                {
                    { 1, null, 5, 1, 1 },
                    { 2, null, 7, 1, 2 },
